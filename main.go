...
func handleWriteBlock(w http.ResponseWriter, r *http.Request) {
	...
	writeAPIData(Blockchain)

	respondWithJSON(w, r, http.StatusCreated, newBlock)
}
func writeAPIData(blockchain []Block) {
...
func main() {
	...
	if *target == "" {
		...
		ha.Peerstore().AddAddr(peerid, targetAddr, math.MaxInt64)
